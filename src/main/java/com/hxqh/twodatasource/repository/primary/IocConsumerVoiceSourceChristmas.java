...
/**
 * The persistent class for the tb_ioc_consumer_christmas database table.
 */
@Entity
@Table(name = "TB_IOC_CONSUMER_CHRISTMAS")
public class IocConsumerVoiceSourceChristmas implements Serializable {
